...
flakeMove.prototype.render = function(ctx) {
    ...
    snowFlake.addColorStop(0, "rgba(251, 253, 105, 0.9)");  /* 此处是雪花颜色，默认是白色 */
    snowFlake.addColorStop(.5, "rgba(251, 253, 105, 0.5)"); /* 若要改为其他颜色，请自行查 */
    snowFlake.addColorStop(1, "rgba(251, 253, 105, 0)");    /* 找16进制的RGB 颜色代码。 */
    ctx.save();
